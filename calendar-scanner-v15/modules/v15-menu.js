...
(function () {
  ...
  function buildUnifiedMenu() {
    ...
    card.querySelectorAll('[data-social]').forEach(button => button.onclick = () => {
      ...
      toast(`Вход через ${label} станет доступен при публикации приложения`, 3200);
    });
